...
class HomeScreen extends StatelessWidget {
          ...
          body: ListView(
            ...
            children: <Widget>[
              ...
              _ServiceTile(
                ...
                currentLevel: level,
                onTap: () => context.goNamed(AppRoute.digitalId.routeName),
              ),
              _ServiceTile(
              ...
              _ServiceTile(
                ...
                requirement: AccessLevel.unverified,
                currentLevel: level,
                onTap: () => context.goNamed(AppRoute.account.routeName),
              ),
            ],
          ),
        );
  ...
  static String _subtitleFor(AccessLevel level) => switch (level) {
    AccessLevel.guest =>
      'Browse municipal services. Sign in to use them.',
...
class _AccessStateCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    final (icon, title, body, actionLabel, route) = switch (session
        .accessLevel) {
      AccessLevel.guest => (
    ...
    return Padding(
      ...
      child: Card(
        child: ListTile(
          ...
          title: Text(title),
          subtitle: Text(meets || requirementLabel == null
              ? subtitle
