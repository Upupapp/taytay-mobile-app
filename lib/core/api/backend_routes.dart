...
const List<BackendRoute> backendRoutes = <BackendRoute>[
  ...
  BackendRoute('GET', 'me/assistance-history', 'assistance_api_repository.dart'),
  BackendRoute('GET', 'me/assistance/drafts', 'assistance_api_repository.dart'),
  BackendRoute('POST', 'me/assistance/drafts', 'assistance_api_repository.dart'),
  BackendRoute('DELETE', 'me/assistance/drafts/{}', 'assistance_api_repository.dart'),
  BackendRoute('POST', 'me/assistance/drafts/{}/submit', 'assistance_api_repository.dart'),
  BackendRoute('GET', 'me/cases/{}', 'assistance_api_repository.dart'),
  BackendRoute('GET', 'me/cases/{}/requirements', 'requirement_api_repository.dart'),
  BackendRoute('POST', 'me/cases/{}/requirements/{}/documents', 'requirement_api_repository.dart'),
  ...
  BackendRoute('GET', 'me/notification-preferences', 'notification_api_repository.dart'),
  BackendRoute('PUT', 'me/notification-preferences', 'notification_api_repository.dart'),
  BackendRoute('GET', 'me/notifications', 'notification_api_repository.dart'),
  BackendRoute('POST', 'me/notifications/read-all', 'notification_api_repository.dart'),
  BackendRoute('POST', 'me/notifications/{}/read', 'notification_api_repository.dart'),
  BackendRoute('GET', 'me/privacy/consents', 'privacy_api_repository.dart'),
  BackendRoute('DELETE', 'me/privacy/consents/{}', 'privacy_api_repository.dart'),
  BackendRoute('GET', 'me/profile', 'auth_api_repository.dart'),
  BackendRoute('POST', 'me/profile/corrections', 'resident_profile_api_repository.dart'),
  ...
  BackendRoute('DELETE', 'newsfeed-comments/{}', 'newsfeed_api_repository.dart'),
  BackendRoute('POST', 'newsfeed-comments/{}/reports', 'newsfeed_api_repository.dart'),
  BackendRoute('GET', 'newsfeed/{}', 'newsfeed_api_repository.dart'),
  ...
  BackendRoute('DELETE', 'newsfeed/{}/reaction', 'newsfeed_api_repository.dart'),
